<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="_1._7_ServerControllers._Default" %>
        ...
        <div class="col-6">
                 <div class="row mt-5">
                        ...
                        <div class="col-7">
                            ...
                            <asp:Image runat="server" Height="300px" Width="269px" id="imgUpload" ImageUrl="https://www.sukhothai.in/wp-content/uploads/2016/07/male-passport-size-2.jpg"/>
                        </div>
